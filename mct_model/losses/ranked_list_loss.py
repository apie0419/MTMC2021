...
class RankedLoss(object):
    ...
    def __init__(self, margin=1.5, alpha=2.5, tval=0):
        self.margin = margin
        self.alpha = alpha
        self.tval = tval
...
if __name__ == "__main__":
    ranked_loss = RankedLoss()
    emb = torch.tensor([[1, 1, 1, 1], [0.01, 0.01, 0.01, 0.01], [0.01, 0.01, 0.01, 0.01], [0.99, 0.99, 0.99, 0.99], [2.00, 2.00, 2.00, 2.00], [2.00, 2.00, 2.00, 2.00]])
    target = torch.tensor([2, 1, 1, 2, 3, 3])
    print (ranked_loss(emb, target))