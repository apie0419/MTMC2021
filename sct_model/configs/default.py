...
_C.MODEL.DETECTION_WEIGHTS = ''

# connectivity in one pair
_C.MODEL.CONNECTIVITY = CN()
_C.MODEL.CONNECTIVITY.KERNEL_SIZE = [3, 5, 9, 13]
_C.MODEL.CONNECTIVITY.FEAT_CHANNELS = [16, 64, 128]
_C.MODEL.CONNECTIVITY.STACK_NUM = 3
...
#appearance
_C.MODEL.APPEARANCE = CN()
_C.MODEL.APPEARANCE.PRETRAINED = True
_C.MODEL.APPEARANCE.WEIGHTS = ''
_C.MODEL.APPEARANCE.EMB_SIZE = 512
_C.MODEL.APPEARANCE.NUM_CLASSES = 667
